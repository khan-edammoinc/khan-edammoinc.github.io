...
function Nav() {
    ...
    return (
        <nav className={"nav " + navModifiers()}>
            ...
            <NavDropdown main={<p className="nav_nonlink">Case Studies</p>/*<Link to="/casestudies" className={(location.pathname === "/casestudies") ? "nav_link--active" : ""}>Case Studies</Link>*/} offset={"Case Studies".length}>
